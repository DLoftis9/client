    ...
    <div className={props.componentName + `__row row`}>
      ...
      <div className={props.componentName + `__content`}>
        ...
        <p className="paragraph">
          ...
          grow and evolve our knowledge base and skill sets. 100 Beans looks forward to helping you
          with your needs, however big or small, or even just an opportunity to say hello and
          connect!
        </p>
      </div>
    </div>

...
import EditTextInputGroupMain from './ToggleConfirmSubs/ToggleConfirmMain';
import Header from './ToggleConfirmHead/Header';

export default class ToggleConfirm extends Component {
  state = {
    isFiltered: false,
    pendingGuest: '',
    guests: [],

...
import * as types from '../../../social/actions/actionTypes';
import * as actions from '../../../social/actions/postsActions';
...
describe('post actions', () => {
  ...
  it('should update a post', done => {
    ...
    mockAxiosSuccess({});
    store.dispatch(actions.editPost('789', 'The text', 'The author')).then(() => {
      const dispatchedAction = store.getActions();
      expect(dispatchedAction[0]).toEqual(expectedAction);
      done();
    });
